...
<root>
  <object dataType="Class" type="Duality.Resources.Texture" id="1">
    <basePixmap dataType="Struct" type="Duality.ContentRef`1[[Duality.Resources.Pixmap]]">
      <contentPath dataType="String">Data\ship_c.Pixmap.res</contentPath>
    </basePixmap>
    <size dataType="Struct" type="OpenTK.Vector2">
      <X dataType="Float">110</X>
      <Y dataType="Float">106</Y>
    </size>
    <oglSizeMode dataType="Enum" type="Duality.Resources.Texture+SizeMode" name="Enlarge" value="0" />
    ...
    <atlas dataType="Class" type="System.Collections.Generic.List`1[[Duality.Rect]]" id="2">
      <_items dataType="Array" type="Duality.Rect[]" id="3" length="8">
        <object dataType="Struct" type="Duality.Rect">
          <x dataType="Float">0</x>
          <y dataType="Float">0</y>
          <w dataType="Float">0.4296875</w>
          <h dataType="Float">0.4140625</h>
        </object>
        <object dataType="Struct" type="Duality.Rect">
          <x dataType="Float">0.4296875</x>
          <y dataType="Float">0</y>
          <w dataType="Float">0.4296875</w>
          <h dataType="Float">0.4140625</h>
        </object>
